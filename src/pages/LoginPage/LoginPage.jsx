...
const LoginPage = () => {
  document.title = "Kids Dream | Login"
    ...
    <h1 className='text-primary fs-6  text-center py-1'>Sign in with google</h1>
    <div className='text-center'>
      <Button className='text-white btn-secondary' onClick={handleGoogleSignIn}><FaGoogle></FaGoogle></Button>
